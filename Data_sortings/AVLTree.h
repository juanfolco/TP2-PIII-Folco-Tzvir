 ...
 */
template <class T> AVLTree<T>::~AVLTree() { clear(root); }
template <class T> void AVLTree<T>::clear(TreeNode<T> *r) {
    if (r == nullptr)
        return;
 ...
 */
template <class T> T AVLTree<T>::search(T data) { return search(data, root); }
template <class T> T AVLTree<T>::search(T data, TreeNode<T> *r) {
    if (r == nullptr)
        throw 404;
 ...
 */
template <class T> void AVLTree<T>::put(T data) { root = put(data, root); }

template <class T> TreeNode<T> *AVLTree<T>::put(T data, TreeNode<T> *r) {
...
template <class T> TreeNode<T> *AVLTree<T>::remove(T data, TreeNode<T> *r) {
    TreeNode<T> *aux;
    if (r == nullptr)
        throw 404;
...
template <class T> T AVLTree<T>::findMax(TreeNode<T> *r) {
    TreeNode<T> *aux = r;
 ...
 * @return
 */
template <class T> bool AVLTree<T>::isEmpty() { return root == nullptr; }

/**
 * Recorre un árbol en preorden
 */
template <class T> void AVLTree<T>::preorder() { preorder(root); }
template <class T> void AVLTree<T>::preorder(TreeNode<T> *r) {
    if (r == nullptr)
        return;
 ...
 */
template <class T> void AVLTree<T>::inorder() { inorder(root); }
template <class T> void AVLTree<T>::inorder(TreeNode<T> *r) {
    if (r == nullptr)
        return;
...
template <class T> void AVLTree<T>::postorder(TreeNode<T> *r) {
    if (r == nullptr)
        return;
 ...
 */
template <class T> void AVLTree<T>::print() { print(true, "", root); }
...
template <class T> int AVLTree<T>::height(TreeNode<T> *r) {
    if (r == nullptr)
        return -1;
    else
        return r->getHeight();
}
template <class T> TreeNode<T> *AVLTree<T>::rotateLeft(TreeNode<T> *k2) {
...
template <class T> TreeNode<T> *AVLTree<T>::rotateRight(TreeNode<T> *k1) {
...
template <class T> TreeNode<T> *AVLTree<T>::doubleRotateLeft(TreeNode<T> *k3) {
    k3->setLeft(rotateRight(k3->getLeft()));
    return rotateLeft(k3);
}
template <class T> TreeNode<T> *AVLTree<T>::doubleRotateRight(TreeNode<T> *k1) {
